      ...
      <div className="pt-24">
        <div className="container mx-auto px-6 py-12">
          <div className="text-center mb-12">
            <h1 className="text-5xl font-bold text-forest mb-6">All Stories & Articles</h1>
            <p className="text-xl text-sage max-w-3xl mx-auto mb-8">
              Explore all my writings about nature, adventures, and magical moments
            </p>
            ...
            <div className="max-w-md mx-auto mb-8">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pl-12 rounded-full border border-sage/30 focus:outline-none focus:ring-2 focus:ring-moss"
                />
                <div className="absolute left-4 top-1/2 transform -translate-y-1/2 text-sage">🔍</div>
              </div>
            </div>
          ...
          {filteredPosts.length === 0 && (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-forest mb-2">No posts found</h3>
              <p className="text-sage">Try adjusting your search or filter criteria</p>
            </div>
          )}
